...
CUR_DIR = os.path.dirname(__file__) #returns a string value which represents the directory name from the specified path.
LISTE_PATH = os.path.join(CUR_DIR, "courses.json") # chaine de caracteres: chemin du fichier json sur le disque dur
...
while True:
    ...
    if choix == "1":
        ...
        print("\n")
        print("_"*50)
        print(f"L'élèment {element} a été ajouté à la liste.")
